...
## Current state
The current codebase still contains older prototype/playground patterns, but the docs above describe the intended next implementation direction for a build agent.
